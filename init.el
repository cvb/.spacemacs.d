...
(custom-set-faces
 ...
 '(lazy-highlight ((t (:background "#116677"))))
 '(org-done ((t (:foreground "forest green" :background nil :weight bold))))
 ...
 '(org-todo ((t (:foreground "#D9D9D9" :weight bold :background nil))))
